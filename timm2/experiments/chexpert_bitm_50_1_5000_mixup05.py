...
def parameters(): 
    defaults = {
        ...
        'grad-accumulation': 1, # 2, #help='increase batchsize virtaully by gradient accumulation. virtual-batch-size = n*batch-size')

        'epochs': 100,  # help='number of epochs to train (default: 300)')
        'epoch-repeats': 0.,
    ...
    # Model parameters
        ...
        'decay-epochs': [30, 60, 94], #help='epoch interval to decay LR')
        ...
        'mixup': 0.5, # help='mixup alpha, mixup enabled if > 0. (default: 0.)')
        ...
        'mixup-prob': 0.5, #help='Probability of performing mixup or cutmix when either/both is enabled')
        ...
        'smoothing': 'False', #help='Training interpolation (random, bilinear, bicubic default: "random")')
        ...
        'checkpoint-hist': 1,  #help='number of checkpoints to keep (default: 10)')
        ...
        'no-prefetcher':  True, # help='disable fast prefetcher')
