...
def parameters(): 
    defaults = {
        ...
        'batch-size': 32, #bit-hyperrule: 256, mit grad_accumulation 2
        'validation-batch-size' : 64,#None, #help = 'validation batch size override (default: None)')
...
def run(dataset, model,  n_labels, data_seed, **kwargs):
    ...
    adapted_args = {
        'dataset': dataset,
        'model': model,
        'data_file_train': f'../data-local/labels/chexpert_correct_labels/{dataset}_{n_labels}_{data_seed:02d}.csv',
