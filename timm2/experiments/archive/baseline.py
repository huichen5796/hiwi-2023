...
def parameters(): 
    defaults = {
        ...
        'grad-accumulation': 2, #help='increase batchsize virtaully by gradient accumulation. virtual-batch-size = n*batch-size')
    ...
    # Model parameters
        'model': 'resnetv2_50x1_bitm_in21k', #'resnetv2_50x3_bitm'
        'pretrained': 'true',
