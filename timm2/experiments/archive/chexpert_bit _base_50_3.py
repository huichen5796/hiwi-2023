...
def parameters(): 
    defaults = {
        ...
        'data_file_train': '../data-local/labels/chexpert/chexpert_1000_00.csv',
        ...
        'batch-size': 64,
        #'validation-batch-size' : None, #help = 'validation batch size override (default: None)')
        'grad-accumulation': 8, #help='increase batchsize virtaully by gradient accumulation. virtual-batch-size = n*batch-size')

        'epochs': 250,  # help='number of epochs to train (default: 300)')
        'epoch-repeats': 0.,
    ...
    # Model parameters
        'model': 'resnetv2_50x3_bitm_in21k', #'resnetv2_50x3_bitm'
        'pretrained': 'true',
        ...
        'weight-decay': 2e-5, #help='weight decay (default: 2e-5)')
        ...
        'sched': 'multistep',  # help = 'LR scheduler (default: "step"')
        ...
        'decay-epochs': [75., 150., 225.], #help='epoch interval to decay LR')
        ...
        'scale': [0.08, 1.0], #metavar='PCT', help='Random resize scale (default: 0.08 1.0)')
        'ratio': [3. / 4., 4. / 3.], #metavar='RATIO', help='Random resize aspect ratio (default: 0.75 1.33)')
        'hflip': 0.5, #help='Horizontal flip training aug probability')
        'vflip': 0., #help='Vertical flip training aug probability')
        'color-jitter': 0.4, # metavar='PCT', help='Color jitter factor (default: 0.4)')
        ...
        'checkpoint-hist': 10,  #help='number of checkpoints to keep (default: 10)')
        'workers': 2,           #help='how many training processes to use (default: 4)')
