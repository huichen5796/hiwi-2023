...
def parameters(): 
    defaults = {
        ...
        'batch-size': 32,
        'validation-batch-size' : 32, #None, #help = 'validation batch size override (default: None)')
    ...
    # Model parameters
        'model': 'vit_base_patch16_224_miil_in21k', #'resnetv2_50x3_bitm'
        'pretrained': 'true',
