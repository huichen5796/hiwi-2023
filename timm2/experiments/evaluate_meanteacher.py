import test_timm_multilabel_meanteacher
...
def parameters(): 
    defaults = {
        ...
        #'data_file_val': '../data-local/chexpert_binary_valid_official.csv',
        'data_file_val': '../data-local/chexpert_frap_binary_valid_official.csv',
    ...
    directory = '../output/train_meanteacher/'
...
def run(**kwargs):
    ...
    test_timm_multilabel_meanteacher.main(args)
