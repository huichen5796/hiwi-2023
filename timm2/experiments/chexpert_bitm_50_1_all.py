...
def run(**kwargs):
    ...
    modelname = 'resnetv2_50x1_bitm_in21k'


    # bit_hyperrule
    bit_batchsize = 512
    bit_num_trainsamples = 10000*512

    max_batchsize_gpu = 256 # resnet_bitm_50
    ...
    adapted_args = {
        'output': outdir,
        'experiment' : timestr,
        'data_file_train' : f'../data-local/chexpert_binary_train.csv',
        'data_file_val': f'../data-local/chexpert_binary_valid.csv',
        'model': modelname,
        ...
        'decay-epochs': [168, 336, 504],
        'warmup-epochs': 5,  # help='epochs to warmup LR, if scheduler supports')
    }
